	...
	<form id="filtros_empleado" method="post">
		...
		<div class="row filtering">
			...
			<div class="col-sm-2 mt-3 d-flex">
				<button class="btn btn-success ml-auto" type="button" onclick="carga_insert_empleado()"><i class="fa-solid fa-plus"></i> Añadir</button>
			</div>
			...
			<div class="col-sm-3 mt-3">
				<div class="input-group">
					...
					<div class="input-group-append">
						<button class="btn btn-outline-primary" type="button" onclick="carga_filtros_empleado()"><i class="fa-solid fa-magnifying-glass"></i></button>
					</div>
				</div>
			</div>
		</div>
