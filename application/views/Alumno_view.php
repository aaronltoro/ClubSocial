<div class="container" id="principal">
	<form id="filtros_alumno" method="post">
		...
		<div class="row filtering">
			...
			<div class="col-sm-2 mt-3 d-flex">
				<button class="btn btn-success ml-auto" type="button" onclick="carga_insert_alumno()"><i class="fa-solid fa-plus"></i> Añadir</button>
			</div>
